 ...
 */
public class Grid extends Shape implements Serializable, Cloneable {
    ...
    public void draw( Graphics2D g2d ) {
        ...
        if ( strokeColor != null ) {
            ...
            for ( int i = 1; i * distance <= screenSize.width; i++ ) {
                g2d.drawLine( i * distance, -10, i * distance, screenSize.height + 10 );
            }
